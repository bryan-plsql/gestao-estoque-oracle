        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:Bryand.720@gmail.com" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <Mail className="h-4 w-4 text-purple-400" />
                Bryand.720@gmail.com
              </a>
              <a href="tel:+5543991244116" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
